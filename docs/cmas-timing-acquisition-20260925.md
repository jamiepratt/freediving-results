...
## Batch 8 revision evidence inspection

Read-only inspection on 25 September 2026 rechecked the retained bytes against acquisition hashes. Two timing-service URLs explicitly end in `-v2.pdf`: senior CWT men (`c3-doc6.pdf`, SHA-256 `8a71457edfed39f01fe03771fcd8478de1cf0b59ed16cd8bf95e36518a150985`) and CWT men M3 (`c3-doc7.pdf`, `272523e821533095df7ab5e287b4721901a7945497a706ed13eb9d263dbc7fc7`). Both printed table dates are 9 September 2025. Their report-created footers say 10 September 2025 at 07:19 and 07:21 respectively, without a timezone. These are report-generation labels, not an explicit correction chronology or a reviewed predecessor relationship.

The inspected tables print rank, name, representation and category, but no athlete-ID or bib column. Rank cannot substitute for a stable participant identifier. The distinct federation CWT men's PDF remains a possible comparison source; different hashes and the timing filename do not prove it is the predecessor or that every row changed. A missing original remains unknown history, without fabricated previous values.
