...
Across the 20 acquired 2025 timing PDFs, 23 pages contain 352 independently reconciled, parsed source rows. This includes the 20 previously unresolved continuation rows. Seventeen PDFs have new `/2` jobs alongside their historical jobs; the three women's PDFs retain `cmas-women-depth/1`. HTML, legacy federation PDFs and 2026 parsing behavior are unchanged. See [batch 4 evidence](docs/cmas-timing-acquisition-20260925.md#batch-4-geometry-backed-continuations) for reconciliation and private artifacts. All rows remain unreviewed and publication-blocked.
