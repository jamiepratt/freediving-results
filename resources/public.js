(function () {
  ...
  function detail(r) {
    ...
    const original = section('From the source to this result', 'Original source tokens are retained separately from parsed values and effective approved corrections. “Not recorded” marks a missing value in that column. Missing units and successful outcomes are never inferred.');
